...
<div class="register-box">
  <div class="register-logo">
    <a href="index2.html"><b>ARIMA </b>Komunika</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg"><b>Informasi Umum</b></p>
    <form action="index.html" method="post">
      ...
      <div class="register-box-body">
        ...
        <input type="button" value="Kembali" class="btn btn-primary btn-block btn-flat" onclick="history.back(-1)" />
