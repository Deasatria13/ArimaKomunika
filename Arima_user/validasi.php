...
<body onload="noBack();"onpageshow="if (event.persisted) noBack();" class="hold-transition login-page">
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Kode Validasi telah dikirim, masukan kode validasi  </p>
